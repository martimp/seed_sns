        ...
        <form method="post" action="" class="form-horizontal" role="form">
          ...
          <table class="table table-striped table-condensed">
            <tbody>
              ...
              <tr>
                <td><div classtext-center">パスワード</div></td>
                <td><div classtext-center"><?php echo $_SESSION['join']['password']; ?></div></td>
              </tr>
              <tr>
                <td><div class="text-center">プロフィール画像</div></td>
                <td><img src="<?php echo "../picture_path/".$_SESSION['join']['picture_path']; ?>" width="100"  height="100"></td>
